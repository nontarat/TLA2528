...
#include "main.h"
#include "stdio.h"
extern I2C_HandleTypeDef hi2c5;  // ใช้ I2C5 ที่กำหนดใน STM32CubeMX

#define TLA2528_I2C_ADDR  (0x10 << 1)  // ที่อยู่ I2C ของ TLA2528
#define TLA2528_I2C_ADDR_W  0x20  // ที่อยู่ I2C ของ TLA2528
#define TLA2528_I2C_ADDR_R  0x21  // ที่อยู่ I2C ของ TLA2528
#define TLA2528_SEQ_MODE_REG  0x02  // Register ควบคุมโหมด
#define TLA2528_PIN_CFG_REG   0x03  // Register ตั้งค่าขาเป็น AIN/GPIO
#define TLA2528_AUTO_SEQ_REG  0x04  // Register เลือกช่องสัญญาณ
#define TLA2528_SEQ_START_REG 0x05  // Register เริ่ม Auto-Sequence
#define TLA2528_RESULT_REG    0x00  // Register อ่านผลลัพธ์
